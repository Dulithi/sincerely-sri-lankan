import { iGVOpportunities } from '@/data/iGVOpportunities'; 
import React from 'react';
import styled from 'styled-components';

const IGVOpportunities = () => {
  return (
    <Container>
      {iGVOpportunities.map((opportunity, index) => (
        <Card key={index}>
          <CardContent>
            ...
            <SDGTarget>{opportunity.sdgTarget}</SDGTarget>
...
export default IGVOpportunities;
